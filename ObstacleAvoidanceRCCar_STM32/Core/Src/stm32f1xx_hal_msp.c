...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(GPIOA, PA6_TIM3_ECHO_L_Pin|PA7_TIM3_ECHO_C_Pin);

    HAL_GPIO_DeInit(PB0_TIM3_ECHO_R_GPIO_Port, PB0_TIM3_ECHO_R_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, PA9_BT_RX_Pin|PA10_BT_TX_Pin);
